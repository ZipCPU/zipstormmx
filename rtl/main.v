...
`include "builddate.v"
	...
	assign	      wb_dio_sel = ((wb_addr[20:16] &  5'h1f) ==  5'h02); // 0x080000 - 0x080007
//x2	Was a master bus as well
	assign	     console_sel = ((wb_addr[20:16] &  5'h1f) ==  5'h03); // 0x0c0000 - 0x0c000f
	assign	      sdcard_sel = ((wb_addr[20:16] &  5'h1f) ==  5'h04); // 0x100000 - 0x10000f
	assign	      wb_sio_sel = ((wb_addr[20:16] &  5'h1f) ==  5'h05); // 0x140000 - 0x14001f
//x2	Was a master bus as well
	assign	       bkram_sel = ((wb_addr[20:16] &  5'h1f) ==  5'h06); // 0x180000 - 0x180fff
...
//x2	Was a master bus as well
	...
	if (wb_stb && ! wb_stall)
		casez(wb_addr[20:16])
			...
			// 007c0000 & 00080000, wb_dio
			5'b000_10: r_wb_bus_select <= 3'd1;
			// 007c0000 & 000c0000, console
			5'b000_11: r_wb_bus_select <= 3'd2;
			// 007c0000 & 00100000, sdcard
